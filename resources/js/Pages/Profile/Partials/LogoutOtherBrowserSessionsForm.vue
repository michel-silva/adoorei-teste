    ...
    <jet-action-section>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Se necessário, você pode sair de todas as outras sessões do navegador em todos os seus dispositivos. Algumas de suas sessões recentes estão listadas abaixo; no entanto, esta lista pode não estar completa. Se você achar que sua conta foi comprometida, você também deve atualizar sua senha.
            </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Digite sua senha para confirmar que deseja sair de suas outras sessões do navegador em todos os seus dispositivos.
